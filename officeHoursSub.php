...
<html lang="en">
  <head>
    ...
    <title>Office Hours Submissions</title>
    <meta
      name="viewport"
    ...
    >
      <div class="app-header header-shadow">
        <div class="app-header__logo">
          ...
          <div><h6>Office Dashboard</h6></div>
                    ...
                    <div class="btn-group">
                      ...
                      >
                        <div class="card-body">
                          ...
                          <p>
                            Email: ab12345@dal.ca<br />Phone: (123) 456 789<p>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div class="app-sidebar sidebar-shadow">
          ...
          <div class="scrollbar-sidebar ps ps--active-y">
            ...
            <ul class="vertical-nav-menu metismenu">
                ...
                <li>
                  <a href="officeHoursSub.php" class="mm-active">
